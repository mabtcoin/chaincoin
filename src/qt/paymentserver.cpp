...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click chaincoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start chaincoin: click-to-pay handler");
    else
...
{
    // clicking on chaincoin: URLs creates FileOpen events on the Mac:
