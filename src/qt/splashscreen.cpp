    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = tr("Masterbitcoin Core");
    ...
    QString copyrightTextChc   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Masterbitcoin Core developers"));
