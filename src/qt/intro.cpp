...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Masterbitcoin"),
     ...
     * override -datadir in the masterbitcoin.conf file in the default data directory
     * (to be consistent with masterbitcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
