...
For more info see <a href=\"https://chaincoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://chaincoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
