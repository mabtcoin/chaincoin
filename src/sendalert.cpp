...
2. run chaincoind with -printalert or -sendalert like this:
   /path/to/chaincoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.chaincoin.org";
