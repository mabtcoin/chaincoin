...
public:
    CMainParams() {
        ...
        nDefaultPort = 11994;
        bnProofOfWorkLimit = ~uint256(0) >> 20;  // Starting difficulty is 1 / 2^20
        ...
        nMinerThreads = 0;
        nTargetTimespan = 90; // Chaincoin: 90 seconds
        nTargetSpacing = 90; // Chaincoin: 90 seconds
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 28);                    // Chaincoin addresses start with 'C'
        base58Prefixes[SCRIPT_ADDRESS] = list_of(  4);                    // Chaincoin script addresses
        base58Prefixes[SECRET_KEY] =     list_of(28 + 128);               // Chaincoin private keys
        ...
        strSporkKey = "04d30fc81685398b8a9f560145ca994f23cc38775e731ebf50f89ef7ead069c312c733ce17450b2c24fff3ed945e5bd096866d1445424f7ed81710f1a8e667ea5d";
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 80);                    // Testnet dash addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 44);                    // Testnet dash script addresses start with '8' or '9'
        ...
        strSporkKey = "04d436c5ea78789b7bd4708c296b61cf2c0a14d0870245d164078e3c126dec0dd7ee041538437afd72508def9862f0f65160de94c9f48861a6a7b25bd59879eeef";
