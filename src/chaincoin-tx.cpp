...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Chaincoin Core chaincoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chaincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chaincoin transaction") + "\n" +
              "  chaincoin-tx [options] -create [commands]   " + _("Create hex-encoded chaincoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chaincoin transaction
