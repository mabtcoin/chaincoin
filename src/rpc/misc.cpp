...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "chaincoin|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of chuffs\n"
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (number) The number of chuffs of the output\n"
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\"  (string) The current balance in chuffs\n"
            "  \"received\"  (string) The total number of chuffs received (including change)\n"
            "}\n"
            "\nExamples:\n"
