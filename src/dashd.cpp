 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Chaincoin (http://www.chaincoin.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/chaincoin.conf are parsed in qt/dash.cpp's main()
