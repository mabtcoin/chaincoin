...
It is possible to run Masterbitcoin as a Tor hidden service, and connect to such services.
...
The first step is running Masterbitcoin behind a Tor proxy. This will already make all
