...
[From the masterbitcoin github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the masterbitcoin.conf file?

If you are using a masternode.conf file you no longer need the masterbitcoin.conf file. The exception is if you need custom settings (thanks oblox).

## Update masterbitcoin.conf on server

If you generated a new masternode private key, you will need to update the remote masterbitcoin.conf files.

Shut down the daemon and then edit the file.

```sudo nano .masterbitcoin/masterbitcoin.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote masterbitcoin.conf file.
