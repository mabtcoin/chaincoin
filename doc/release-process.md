...
##perform gitian builds
 ...
 Build masterbitcoind and masterbitcoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit masterbitcoin=v${VERSION} ../masterbitcoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../masterbitcoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r masterbitcoin-${VERSION}-linux-gitian.zip *
	mv masterbitcoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit masterbitcoin=v${VERSION} ../masterbitcoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../masterbitcoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r masterbitcoin-${VERSION}-win-gitian.zip *
	mv masterbitcoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit masterbitcoin=v${VERSION} ../masterbitcoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
